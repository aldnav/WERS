                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('contact_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="contact_number" type="contact_number" class="form-control" name="contact_number" value="{{ old('contact_number') }}" placeholder="09xx-xxx-xxxx" required>

                                @if ($errors->has('contact_number'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('contact_number') }} Follow this format: 09xx-xxx-xxxx.</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
